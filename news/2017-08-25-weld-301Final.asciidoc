...
But, for those of you who like to stay sharp, we have also created a link:http://download.jboss.org/weld/3.0.1.Final/wildfly-11.0.0.Beta1-weld-3.0.1.Final-patch.zip[patch for WildFly 11.0.0.Beta1, window="_blank"].
